...
describe RSpec::Core do
  ...
  describe "#configuration" do
    if(GC.respond_to?(:count) && !defined?(JRuby))
      ...
      it "doesn't do squat because our Ruby doesn't have the relevant GC features" do
        pending "Skipping GC test on Ruby that doesn't have the relevant GC features."
      end
    end
  end
